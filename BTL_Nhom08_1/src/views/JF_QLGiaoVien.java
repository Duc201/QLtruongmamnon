...
public void luuHinhAnh(GiaoVien gv) {
    try {
        ...
        File destinationDir = new File("src" + File.separator + "Teacher_Img");
        if (!destinationDir.exists()) {
            destinationDir.mkdirs(); // Tạo thư mục nếu nó không tồn tại
        }
        
        // Ta lưu bản copy hình ảnh với tên file = mã GV + ".png"
        BufferedImage image = ImageIO.read(inputFile);
        File outFile = new File(destinationDir.getAbsolutePath() + File.separator + gv.getMaGV() + ".png");
        ImageIO.write(image, "png", outFile);
    } catch (Exception ex) {
        String errorMessage = "Lỗi khi lưu bản copy: " + ex.getMessage();
...
//                String errorMessage = "Lỗi khi Hien thi hinh anh : " + ex.getMessage();
//            JOptionPane.showMessageDialog(null, errorMessage, "Lỗi", JOptionPane.ERROR_MESSAGE);
//            ex.printStackTrace();
//            }
//    }
...
//            System.out.println("Error: Image file does not exist or is not a valid image.");
//            String errorMessage = "Lỗi khi Hiển thị hình ảnh: Tập tin hình ảnh không tồn tại hoặc không hợp lệ.";
//            JOptionPane.showMessageDialog(null, errorMessage, "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
    } catch (IOException ex) {
        System.out.println("Error: " + ex.toString());
        String errorMessage = "Lỗi khi Hiển thị hình ảnh : " + ex.getMessage();
        JOptionPane.showMessageDialog(null, errorMessage, "Lỗi", JOptionPane.ERROR_MESSAGE);
        ex.printStackTrace();
    }
}
    ...
    public void lamMoi(){
        ...
        setImageLabel("src\\images\\Edit.png");
