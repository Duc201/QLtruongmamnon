...
import controller.Controller_QLLop_DanhGia;
...
private int selectedRow = -1;
    ...
    public QL_Lop_DanhGia() {
      ...
      // setSize(1920, 1080);
        ...
        connectedDanhGiaDB = new Controller_QLLop_DanhGia();
        creatTable();
    ...
    if (ComboboxLopHoc.getSelectedItem() != null) {
        ...
        connectedDanhGiaDB.layDachSachHocSinh1Lop(maLop, listHocSinh , listChiTiet);
...
private void timKiemDanhGia() {
    ...
    if (ComboboxLopHoc.getSelectedItem() != null) {
        String tenLophoc = ComboboxLopHoc.getSelectedItem().toString();
        connectedDanhGiaDB.layDachSachHocSinh1Lop(tenLophoc, listHocSinh , listChiTiet);
        tableModel.setRowCount(0); // Xóa dữ liệu trong bảng hiện tại
        for (HocSinh hs : listHocSinh){
            for(Chitiethocsinh ct :listChiTiet )
            {
...
private Controller_QLLop_DanhGia connectedDanhGiaDB;
